...
_TEMPLATES: list[dict] = [
    ...
    {
        "name": "Trail Scout",
        "description": "Complete 1 expedition today.",
        "quest_type": QuestType.DAILY,
    ...
    {
        "name": "Trail Runner",
        "description": "Complete 2 expeditions today.",
        "quest_type": QuestType.DAILY,
        "condition": QuestCondition.COMPLETE_EXPEDITIONS,
        "condition_value": 2,
        "reward_type": RewardType.RYO,
    ...
    {
        "name": "First Bond",
        "description": "Bond 1 Pok̩mon on an expedition today.",
        "quest_type": QuestType.DAILY,
    ...
    {
        "name": "Bond Patrol",
        "description": "Bond 3 Pok̩mon on expeditions today.",
        "quest_type": QuestType.DAILY,
        "condition": QuestCondition.BOND_POKEMON,
        "condition_value": 3,
        "reward_type": RewardType.RYO,
    ...
    {
        "name": "Field Notes",
        "description": "Complete 5 expeditions this week.",
        "quest_type": QuestType.WEEKLY,
        "condition": QuestCondition.COMPLETE_EXPEDITIONS,
        "condition_value": 5,
        "reward_type": RewardType.RYO,
    ...
    {
        "name": "Deep Trail Ledger",
        "description": "Complete 10 expeditions this week.",
        "quest_type": QuestType.WEEKLY,
        "condition": QuestCondition.COMPLETE_EXPEDITIONS,
        "condition_value": 10,
        "reward_type": RewardType.RYO,
    ...
    },
    {
        ...
        "description": "Bond Pok̩mon representing 3 different types this week.",
        "quest_type": QuestType.WEEKLY,
        "condition": QuestCondition.BOND_POKEMON,
        "condition_value": 3,
